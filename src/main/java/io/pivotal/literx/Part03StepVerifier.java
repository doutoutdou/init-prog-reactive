...
//========================================================================================
    ...
    void expectSkylerJesseComplete(Flux<User> flux) {
        ...
        StepVerifier.create(flux).assertNext(u -> assertThat(u.getUsername()).isEqualTo("swhite")).assertNext(v -> assertThat(v.getUsername()).isEqualTo("jpinkman"));
...
//========================================================================================
    ...
    void expect3600Elements(Supplier<Flux<Long>> supplier) {
        StepVerifier
            ...
            .expectNextCount(3600).expectComplete().verify();
    }
